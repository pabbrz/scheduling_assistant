export default function CreateTask() {
  ...
  <div className="mb-3 col-3 me-3">
    ...
    <select name="assigned_user" className="form-select" aria-label="Default select example">
    ...
    <div className="mb-3 col-3 me-3">
        <label htmlFor="deadline" className="form-label">
            ...
            <input type="date" className="form-control" name="deadline" id="deadline" min={new Date().toISOString().split("T")[0]} />
    </div>
  </div>
